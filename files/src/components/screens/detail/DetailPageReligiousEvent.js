  ...
  return (
    <React.Fragment>
      <InnerNavbar
        title="Title Header"
        backClick="/"
        titleClick={`/detail/${religieuxData.detail_page}`}
        shareTitle="Chateau La Tournelle"
        shareLink={`${baseUrl}/detail/${religieuxData.detail_page}`}
...
export default DetailPageReligiousEvent;
