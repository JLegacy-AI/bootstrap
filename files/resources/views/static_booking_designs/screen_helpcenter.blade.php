                        ...
                        <div class="row m-0 p-0 screen__hcheadmbl">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 px-md-3">
                                <div class="screen__dsplyflexstart m-0">
                                    <a href="javascript:void(0);" onclick="" class="screen__hc_btncross" id="">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 p-0">
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter1">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_premierpas" aria-expanded="false" aria-controls="hc_premierpas">
                                                    <span>Premier pas</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_premierpas" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter1">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">Parkme, c’est quoi ?</a></li>
                                                    <li><a href="#">Comment ça marche ? </a></li>
                                                    <li><a href="#">Mon véhicule est-il sécurisé à Parkme ?</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter2">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_reserver" aria-expanded="false" aria-controls="hc_reserver">
                                                    <span>Réserver</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_reserver" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter2">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter3">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_modification" aria-expanded="false" aria-controls="hc_modification">
                                                    <span>Modification</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_modification" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter3">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter4">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_annulation" aria-expanded="false" aria-controls="hc_annulation">
                                                    <span>Annulation</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_annulation" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter4">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter5">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_navette" aria-expanded="false" aria-controls="hc_navette">
                                                    <span>Navette</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_navette" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter5">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter6">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_servicesupplementaire" aria-expanded="false" aria-controls="hc_servicesupplementaire">
                                                    <span>Service supplémentaire</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_servicesupplementaire" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter6">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter7">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_paiement" aria-expanded="false" aria-controls="hc_paiement">
                                                    <span>Paiement</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_paiement" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter7">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter8">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_support" aria-expanded="false" aria-controls="hc_support">
                                                    <span>Support</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_support" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter8">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter9">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_localisation" aria-expanded="false" aria-controls="hc_localisation">
                                                    <span>Localisation</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_localisation" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter9">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading" role="tab" id="helpcenter10">
                                            <h4 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#hc_compte" aria-expanded="false" aria-controls="hc_compte">
                                                    <span>Compte</span>
                                                </a>
                                            </h4>

                                        </div>
                                        <div id="hc_compte" class="panel-collapse collapse" role="tabpanel" aria-labelledby="helpcenter10">
                                            <div class="panel-body">
                                                <ul class="screen__hcul">
                                                    <li><a href="#">?</a></li>
                                                    <li><a href="#">?</a></li>
