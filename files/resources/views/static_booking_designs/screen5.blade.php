                                                ...
                                                <div class="col-12 screen4-tabs-div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="Marque véhicule* (ex: Peugeot)" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="screen4-tabs row">
                                                <div class="col-12 screen4-tabs-div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="Modèle véhicule* (ex:208)" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="screen4-tabs row">
                                                <div class="col-12 screen4-tabs-div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            placeholder="Plaque immatriculation (facultatif)" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 screens-btndiv text-center">
                                            <a href="javascript:void(0);" class="screen-btn" id="">Confirmer véhicule</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
