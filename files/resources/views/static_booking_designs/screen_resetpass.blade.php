...
<body class="">
    ...
    <main>
        ...
        <section id="screen_01" class="">
            ...
            <input type="hidden" id="screen__resetpass_inp" value="0" />
            <input type="hidden" id="screen__resetpassconfirm_inp" value="0" />
            <div class="container screen__resetpass_main">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 screen__connx_div">
                        <div class="screen__connx_yellow">
                            ...
                            <div class="screen__crossicon">
                                <a href="javascript:void(0);" onclick="closeResetPassModal()" class="screen-btn-cross" id="">
                                            ...
                                            <div class="screen4-tabs row">
                                                <div class="col-12 screen4-tabs-div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control form-control-lg form-check-input" id="newpassword" name="newpassword" placeholder="Mot de passe*" required />
                                                    </div>
                                                </div>
                                                <div class="col-12 screen4-tabs-div">
                                                    <div class="form-group">
                                                        <label for="confirmnewpassword">Confirmer mot de passe</label>
                                                        <input type="password" class="form-control form-control-lg form-check-input" id="confirmnewpassword" name="confirmnewpassword" placeholder="Confirmer mot de passe*" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 screen-pass-btndiv text-center">
                                            <a href="javascript:void(0);" class="screen-btn" onclick="openResetPassConfirmModal()" id="">Réinitialliser mot de passe</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container screen__resetpass_confirm">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12 screen__connx_div">
                        <div class="screen__connx_yellow">
