                                ...
                                <div class="pd-screen screen1page-new m-0">
                                    ...
                                    <div class="row" id="">
                                                ...
                                                <div class="col-12 screen4-tabs-div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="name" name="name" aria-describedby="nameError"
                                            ...
                                            <div class="screen4-tabs row">
                                                <div class="col-12 screen4-tabs-div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control form-control-lg form-check-input"
                                                            id="telephoneNumber" name="phone"
                                                            aria-describedby="telephoneNumberError"
                                                            placeholder="Numéro téléphone*" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="screen4-tabs row">
                                                <div class="col-12 screen4-tabs-div">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email"
                                                            class="form-control form-control-lg form-check-input"
                                                            id="email" name="email" aria-describedby="emailError"
                                        ...
                                        <div class="col-12 screens-btndiv text-center">
                                            <a href="javascript:void(0);" class="screen-btn" id="">Confirmer contact</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
