...
<body class="">
                                    ...
                                    <div class="col-12 p-0 new_reserv_left_section1">
                                        <div class="row m-0">
                                            <div class="col-12 new_reserv_left_subsection1 m-0">
                                                ...
                                                <div>
                                                    <span class="new_reserv_left_headnumber">#{{ $order->id }}</span>
                                            ...
                                            <div class="col-12 new_reserv_left_subsection3_2 m-0">
                                                <div class="row screen__3Mdl_dflx new_reserv_left_subsection3_2details">
                                                    ...
                                                    <div class="col-11 new_reserv_left_subsection3_2markinfo pl-0">
                                                        <h2 class=""><span id="">{{ $order->start_date }}</span> - <span id="">{{ $order->start_time }}</span></h2>
                                                        <h2 class=""><span id="">{{ $order->end_date }}</span> - <span id="">{{ $order->end_time }}</span></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-12 new_reserv_left_subsection5_2main">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-7 col-7 new_reserv_left_section5_textdiv pl-0">
                                                                <h2>{{ $order->vehicle }} {{ $order->vehiclemodel }}</h2>
                                                                <p>{{ $order->vehiclefaculty??'N/A' }}</p>
                                                                <a href="javascript:void(0);" id="">{{ $order->service_type??'Aucun lavage' }}</a>
                                                            </div>
                                    ...
                                    <div class="col-12 m-0 new_reserv_right_section2">
                                        ...
                                        <div class="row m-0">
                                            ...
                                            <div class="col-6 p-0 text-right">
                                                <p class="new_reserv_right_section2_p">{{$order->parking_charges}}€</p>
                                            </div>
                                        </div>
                                        <div class="row m-0">
                                            <div class="col-6 p-0 text-left">
                                        ...
                                        <div class="row m-0">
                                            <div class="col-6 p-0 text-left">
                                                <p class="new_reserv_right_section2_p">@if(isset($order->service_type)) {{$order->service_type}} @else Aucun lavage @endif</p>
                                            </div>
                                            <div class="col-6 p-0 text-right">
                                                <p class="new_reserv_right_section2_p">{{$order->services_charges??0}}€</p>
                                            </div>
                                        </div>
                                        <div class="row m-0">
                                            <div class="col-6 p-0 text-left">
                                            ...
                                            <div class="col-6 p-0 text-right">
                                                <p class="new_reserv_right_section2_total">{{$order->price??0}}€</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-10 offset-xl-1 col-lg-12 col-md-12 col-sm-12 col-12 new_pd_dsk">
                            <div class="screen_new_reserv_Modalpd_mod screen_new_reservpage_new">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" id="service_charges" value="{{ $order->services_charges }}">
                                                    <input type="hidden" id="price" value="{{ $order->price }}">
                                                    <input type="date" class="form-control form-control-lg new_reserv_mdl_input" onchange="getUpdatedRate()" name="" id="arriveeDate" value="{{ $formDate }}" placeholder="Date arrivée" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                                    <label for="" class="new_reserv_mdl_input_label">&nbsp;</label>
                                                    <select class="form-control form-control-lg new_reserv_mdl_input" onchange="getUpdatedRate()" id="arriveeTime" name="start_time" required>
                                                    @foreach($timeslots as $timeslot)
                                                    <option <?= $order->start_time == $timeslot->timeslot? 'selected':'' ?>><?php echo $timeslot->timeslot; ?></option>
                                                    @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control form-control-lg new_reserv_mdl_input" onchange="getUpdatedRate()" name="" id="departDate" value="{{ $formeDate }}" placeholder="Date retour" autocomplete="off" required>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                                    <label for="" class="new_reserv_mdl_input_label">&nbsp;</label>
                                                    <select class="form-control form-control-lg new_reserv_mdl_input" onchange="getUpdatedRate()" id="departTime" name="end_time" required>
                                                    @foreach($timeslots as $timeslot)
                                                    <option <?= $order->end_time == $timeslot->timeslot? 'selected':'' ?>><?php echo $timeslot->timeslot; ?></option>
                                                    @endforeach
                                                </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12" id="_extra_container" style="display:none">
                                    ...
                                    <div class="col-12 new_reserv_mdlbtndiv text-center">
                                        ...
                                        <a href="javascript:void(0);" class="new_reserv_mdlbtn new_reserv_mdlbtn_gray" id="btn-disabled">Changer date</a>
                                        <a href="javascript:void(0);" class="new_reserv_mdlbtn new_reserv_mdlbtn_black" style="display:none" id="btn-active" onclick="openPaymentModal()">Changer date</a>
    ...
    <script>
        function getUpdatedRate(){
            // departDate
            // departtime
            // arriveeDate
            // arriveeTime
            // /modify-booking-by-user POST
            $.ajax({
                type: "POST",
                url: "{{url('modify-booking-by-user')}}",
                dataType: "json",
                data: {
                    "price": $('#price').val(),
                    "service_charges": $('#service_charges').val(),
                    "start_date": $('#arriveeDate').val(),
                    "start_time": $('#arriveeTime').val(),
                    "end_date": $('#departDate').val(),
                    "end_time": $('#departTime').val()
                },
                success: function(data) {
                    $('#_extra_container').css('display','flex');
                    if(data.type == 'to_pay'){
                        $('#_extra_data').html("Total à payer: "+data.extra+"€");
                    }
                    if(data.type == 'to_refund'){
                        $('#_extra_data').html("Remboursement de: "+data.extra+"€");
                    }
                    if(data.type == 'no_action_required'){
                        $('#_extra_data').html("Aucune action requise: "+data.extra+"€");
                    }
                },
